...
public final class login_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<div class=\"brand mt-5\">\n");
      out.write("\t\t\t\t\t\t<img src=\"img/name.png\" alt=\"logo\" height=\"100px\">\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" name=\"signin\" class=\"btn btn-primary btn-block\">\n");
      out.write("\t\t\t\t\t\t\t\t\t\tLogin\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"mt-4 text-center\">\n");
      out.write("\t\t\t\t\t\t\t\t\tDon't have an account? <a href=\"reg.jsp\">Register</a>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t</form>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
